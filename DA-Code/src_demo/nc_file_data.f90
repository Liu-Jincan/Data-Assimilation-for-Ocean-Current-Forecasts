...
!                                                MODULE NAME : NcFileData
!                                                OLD VERSION : 2005/01/29
!                                                OLD VERSION : 2005/03/17
!                                                OLD VERSION : 2005/03/28
!                                                PRESENT VERSION : 2007/09/20
!
...
!-------------------------------------------------------------------------------
!
!  5. subroutine variable_define
!
!     - 2 interfaces:
!
!    5.1 variable_define(NcID, VarName, VarType, VarDimsName [, VarID])
!     * integer :: NcID = unit number of opened netcdf file.
...
!
!    5.2 variable_define(NcID, VarName, VarType, VarDims [, VarID])
!     * integer :: NcID = unit number of opened netcdf file.
!     * character :: VarName = the name of this variable.
!     * integer :: VarType = the type of variable (use integer).
!          ( nf_int1 = 1, nf_char = 2, nf_int2 = 3, nf_int = 4, 
...
!-------------------------------------------------------------------------------
!
!  6. subroutine set_attribute(NcID, AttName, Att [, VarName])
!     * integer :: NcID = unit number of opened netcdf file.
...
!-------------------------------------------------------------------------------
!
!  7. subroutine writenc(NcID, VarName, Var [, RecNum])
!     * integer :: NcID = unit number of opened netcdf file.
...
!-------------------------------------------------------------------------------
!
!  9. subroutine readnc(NcID, VarName, Var [, RecNum])
!     * integer :: NcID = unit number of opened netcdf file.
!     * character(len=*) :: VarName = the name of variable in netcdf file.
!     # character(len=*)/char/integer/integer*1/integer*2/real/double presion ::
...
!-------------------------------------------------------------------------------
!
!  10. function get_dimension_len(NcID, DimName)
!     * integer :: NcID = unit number of opened netcdf file.
...
!-------------------------------------------------------------------------------
  ...
  public get_dimension_len
  public open_nc, close_nc, end_define, readnc, writenc
  public dimension_define, variable_define, set_attribute, get_attribute
...
!-------------------------------------------------------------------------------
  ...
  interface variable_define
    module procedure variable_define_notype1, variable_define_notype2
...
!-------------------------------------------------------------------------------
  ...
  interface writenc
    module procedure &
    writenc_0d_int1, writenc_0d_int2, writenc_0d_int, writenc_0d_real, writenc_0d_double, &
    writenc_1d_int1, writenc_1d_int2, writenc_1d_int, writenc_1d_real, writenc_1d_double, &
    writenc_2d_int1, writenc_2d_int2, writenc_2d_int, writenc_2d_real, writenc_2d_double, &
    writenc_3d_int1, writenc_3d_int2, writenc_3d_int, writenc_3d_real, writenc_3d_double, &
    writenc_4d_int1, writenc_4d_int2, writenc_4d_int, writenc_4d_real, writenc_4d_double, &
    writenc_0d_text, writenc_1d_text, writenc_2d_text, writenc_3d_text, writenc_4d_text
...
!-------------------------------------------------------------------------------
  ...
  interface readnc
    module procedure &
    readnc_0d_int1, readnc_0d_int2, readnc_0d_int, readnc_0d_real, readnc_0d_double, &
    readnc_1d_int1, readnc_1d_int2, readnc_1d_int, readnc_1d_real, readnc_1d_double, &
    readnc_2d_int1, readnc_2d_int2, readnc_2d_int, readnc_2d_real, readnc_2d_double, &
    readnc_3d_int1, readnc_3d_int2, readnc_3d_int, readnc_3d_real, readnc_3d_double, &
    readnc_4d_int1, readnc_4d_int2, readnc_4d_int, readnc_4d_real, readnc_4d_double, &
    readnc_0d_text, readnc_1d_text, readnc_2d_text, readnc_3d_text, readnc_4d_text
  end interface readnc

!-------------------------------------------------------------------------------

  include 'netcdf.inc'
  integer :: status, VarID, i
  character(len=80) :: version = 'NcFileData 2.0, '                    &
                               // 'by Xunqiang Yin, 2007-9-20 18:12.'
...
!-------------------------------------------------------------------------------
! --- To define variables.
!*DeckYinxq: variable_define_notype1

  subroutine variable_define_notype1(NcID, VarName, VarType, VarDims, VarID)
  implicit none
  integer, intent(in) :: NcID
  ...
  return
  end subroutine variable_define_notype1

!-------------------------------------------------------------------------------
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
!-------------------------------------------------------------------------------
! --- To define variables.
!*DeckYinxq: variable_define_notype2

  subroutine variable_define_notype2(NcID, VarName, VarType, VarDimsName, VarID)
  implicit none
  integer, intent(in) :: NcID
  character(len=*), intent(in) :: VarName
  ...
  return
  end subroutine variable_define_notype2
...
!*DeckYinxq: writenc_1d_int1
  ...
  subroutine writenc_1d_int1(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_1d_int2
  ...
  subroutine writenc_1d_int2(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_1d_int
  ...
  subroutine writenc_1d_int(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_1d_real
  ...
  subroutine writenc_1d_real(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_1d_double
  ...
  subroutine writenc_1d_double(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_1d_text
  ...
  subroutine writenc_1d_text(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_1d_int1
  ...
  subroutine readnc_1d_int1(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_1d_int2
  ...
  subroutine readnc_1d_int2(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_1d_int
  ...
  subroutine readnc_1d_int(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_1d_real
  ...
  subroutine readnc_1d_real(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_1d_double
  ...
  subroutine readnc_1d_double(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_1d_text
  ...
  subroutine readnc_1d_text(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_2d_int1
  ...
  subroutine writenc_2d_int1(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_2d_int2
  ...
  subroutine writenc_2d_int2(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_2d_int
  ...
  subroutine writenc_2d_int(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_2d_real
  ...
  subroutine writenc_2d_real(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_2d_double
  ...
  subroutine writenc_2d_double(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_2d_text
  ...
  subroutine writenc_2d_text(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_2d_int1
  ...
  subroutine readnc_2d_int1(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_2d_int2
  ...
  subroutine readnc_2d_int2(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_2d_int
  ...
  subroutine readnc_2d_int(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_2d_real
  ...
  subroutine readnc_2d_real(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_2d_double
  ...
  subroutine readnc_2d_double(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_2d_text
  ...
  subroutine readnc_2d_text(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_3d_int1
  ...
  subroutine writenc_3d_int1(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_3d_int2
  ...
  subroutine writenc_3d_int2(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_3d_int
  ...
  subroutine writenc_3d_int(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_3d_real
  ...
  subroutine writenc_3d_real(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_3d_double
  ...
  subroutine writenc_3d_double(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_3d_text
  ...
  subroutine writenc_3d_text(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_3d_int1
  ...
  subroutine readnc_3d_int1(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_3d_int2
  ...
  subroutine readnc_3d_int2(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_3d_int
  ...
  subroutine readnc_3d_int(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_3d_real
  ...
  subroutine readnc_3d_real(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_3d_double
  ...
  subroutine readnc_3d_double(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_3d_text
  ...
  subroutine readnc_3d_text(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_4d_int1
  ...
  subroutine writenc_4d_int1(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_4d_int2
  ...
  subroutine writenc_4d_int2(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_4d_int
  ...
  subroutine writenc_4d_int(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_4d_real
  ...
  subroutine writenc_4d_real(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_4d_double
  ...
  subroutine writenc_4d_double(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: writenc_4d_text
  ...
  subroutine writenc_4d_text(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_4d_int1
  ...
  subroutine readnc_4d_int1(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_4d_int2
  ...
  subroutine readnc_4d_int2(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_4d_int
  ...
  subroutine readnc_4d_int(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_4d_real
  ...
  subroutine readnc_4d_real(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_4d_double
  ...
  subroutine readnc_4d_double(ncid, VarName, Var, RecNum)
  implicit none
...
!*DeckYinxq: readnc_4d_text
  ...
  subroutine readnc_4d_text(ncid, VarName, Var, RecNum)
  implicit none
