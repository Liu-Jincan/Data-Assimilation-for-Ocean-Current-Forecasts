...
if(match_spinup==1)
    ...
    HS_matchnameINtable='nc_WithWW3_ENOI_WW3_P125_16days_2020_nc_ndbc_nc_match_WVHT'; %一般更改ww3_2018_nc即可
    path_Ndbc_nc_match_Hs_Fig_spinup = strcat(path_save,'nc_WithWW3_ENOI_WW3_P125_16days_2020_nc_Ndbc_nc_match_Hs_Fig_spinup/'); %一般更改ww3_2018_nc即可
